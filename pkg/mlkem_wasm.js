...
* @returns {string}
*/
export function decapsulate(ciphertext_b64, secret_key_b64) {
    let deferred3_0;
    let deferred3_1;
    try {
...
* @returns {any}
*/
export function encapsulate(public_key_b64) {
...
* @returns {string}
*/
export function derive_aes_key(shared_secret_b64) {
    let deferred2_0;
    let deferred2_1;
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(shared_secret_b64, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.derive_aes_key(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        deferred2_0 = r0;
        deferred2_1 = r1;
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('mlkem_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
